<template>
    <div class="tools-div">
      <el-button type="success" size="small" @click="exportData">내보내기</el-button>
      <el-button type="primary" size="small" @click="importData">가져오기</el-button>
    </div>

    <el-dialog v-model="dialogImportVisible" title="가져오기" width="30%">
        <el-form label-width="120px">
            <el-form-item label="분류 파일">
                <el-upload
                          class="upload-demo"
                          ...
                          :headers="headers"
                          >
                    <el-button type="primary">업로드</el-button>
                </el-upload>
            </el-form-item>
        </el-form>
    </el-dialog>
    ...
    >
        <el-table-column prop="name" label="분류 이름" />
        <el-table-column prop="imageUrl" label="아이콘" #default="scope">
            <img :src="scope.row.imageUrl" width="50" />
        </el-table-column>
        <el-table-column prop="orderNum" label="정렬" />
        <el-table-column prop="status" label="상태" #default="scope">
        {{ scope.row.status == 1 ? '정상' : '중지' }}
        </el-table-column>
