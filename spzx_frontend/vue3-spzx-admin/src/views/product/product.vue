<template>
    ...
    <el-table :data="list" style="width: 100%">
        ...
        <el-table-column prop="name" label="상품 이름" width="160" />
        <el-table-column prop="brandName" label="브랜드" />
        <el-table-column prop="category1Name" label="1차 분류" />
        <el-table-column prop="category2Name" label="2차 분류" />
        <el-table-column prop="category3Name" label="3차 분류" />
        <el-table-column prop="unitName" label="측정 단위" />
        ...
        <el-table-column prop="auditStatus" label="검토 상태" #default="scope">
            {{
    ...
    <el-dialog v-model="dialogVisible" title="추가 또는 수정" width="80%">
        <el-form label-width="120px" style="margin-top: 10px;" :label-position="labelPosition">
            <el-collapse v-model="activeNames">
                <el-collapse-item title="상품 기본 정보" name="productBaseInfo">
                    ...
                    <el-form-item label="브랜드">
                        <el-select class="m-2" placeholder="브랜드 선택" v-model="product.brandId" style="width: 100%;">
                            <el-option 
                ...
                <el-collapse-item title="상품 SKU 정보" name="skuInfo">
                    <el-form-item label="규격 선택">
                        <el-select
                    ...
                    <el-form-item label="상품 SKU">
                    <el-table :data="product.productSkuList" border style="width: 100%">
                        <el-table-column prop="skuSpec" label="사양" width="180" />
                        <el-table-column label="이미지" #default="scope" width="80">
                          <el-upload
                        ...
                        <el-table-column label="판매 가격" #default="scope">
                            <el-input v-model="scope.row.salePrice" />
                        </el-table-column>
                        <el-table-column label="시가" #default="scope">
                            <el-input v-model="scope.row.marketPrice" />
                        </el-table-column>
                        <el-table-column label="원가" #default="scope">
                            <el-input v-model="scope.row.costPrice" />
                        </el-table-column>
                        <el-table-column label="재고 수량" #default="scope">
                            <el-input v-model="scope.row.stockNum" />
                        </el-table-column>
                        <el-table-column label="무게" #default="scope">
                            <el-input v-model="scope.row.weight" />
                        </el-table-column>
                        <el-table-column label="부피" #default="scope">
                ...
                <el-collapse-item title="상품 상세 정보" name="productDetails">
                    <el-form-item label="상세 이미지">
                        <el-upload
                ...
                <el-collapse-item title="데이터 수정 저장" name="submit" :disabled="true">
                    <el-form-item>
    ...
    <el-dialog v-model="dialogAuditVisible" title="승인" width="80%">
    <el-form :model="product" label-width="120px" style="margin-top: 10px;">
      <el-divider />
      <span style="margin-bottom: 5px;">상품 기본 정보</span>
      <el-row>
        <el-col :span="12">
      ...
      <el-divider />
      <span style="margin-bottom: 5px;">상품 SKU 정보</span>
      <el-form-item label="상품 SKU">
        <el-table :data="product.productSkuList" border style="width: 100%">
          <el-table-column prop="skuSpec" label="사양" width="180" />
          <el-table-column label="이미지" #default="scope" width="80">
          ...
          <el-table-column label="판매 가격" prop="salePrice" />
          <el-table-column label="시중 가격" prop="marketPrice" />
          <el-table-column label="원가" prop="costPrice" />
          <el-table-column label="재고 수량" prop="stockNum" />
          <el-table-column label="무게" prop="weight" />
          <el-table-column label="부피" prop="volume" />
        </el-table>
      </el-form-item>

      <el-divider />
      <span style="margin-bottom: 5px;">상품 상세 정보</span>
      <el-form-item label="상세 이미지">
        <img
